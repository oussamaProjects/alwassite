                ...
                <form class="form" method="POST" action="{{ route('register.custom') }}">
                    ...
                    <div class="card card-login card-hidden mb-3">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="bmd-form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="nom" class="form-control"
                                        placeholder="{{ __('Last name...') }}" value="{{ old('nom') }}" required>
                                </div>
                                @if ($errors->has('nom'))
                            ...
                            <div class="bmd-form-group{{ $errors->has('prenom') ? ' has-danger' : '' }} mt-3">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                            <i class="material-icons">face</i>
                                    ...
                                    <input type="text" name="prenom" class="form-control"
                                        placeholder="{{ __('First name...') }}" value="{{ old('prenom') }}" required>
                                </div>
                                @if ($errors->has('prenom'))
                                    <div id="name-error" class="error text-danger pl-3" for="prenom"
                                        style="display: block;">
