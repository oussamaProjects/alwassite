@extends('layouts.app', ['activePage' => 'messages', 'titlePage' => __('Manage messages')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('messages.store') }}" autocomplete="off" class="form-horizontal">
                        @csrf

                        <div class="card ">
                            <div class="card-header card-header-info">
                                <h4 class="card-title">{{ __('Add message') }}</h4>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    <a class="editClaimType" rel="tooltip" class="btn btn-success btn-link"
                                                        ...
                                                        data-id="{{ $message->id }}" data-target="#messageModal">
        ...
        <script>
            $(document).ready(function() {
                ...
                $('body').on('click', '.editClaimType', function(event) {
                    ...
                    event.preventDefault();
                    var id = $(this).data('id');
                    $.get('message/' + id + '/edit', function(data) {
                        console.log(data);
                        $('#message_id').val(data.data.id);
