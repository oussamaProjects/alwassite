@extends('layouts.app', ['activePage' => 'categories', 'titlePage' => __('Manage categories')])
...
@section('content')
                    ...
                    <form method="post" action="{{ route('categories.store') }}" autocomplete="off"
                        ...
                        <div class="card ">
                            <div class="card-header card-header-info">
                                ...
                                <p class="card-category">{{ __('Categories information') }}</p>
                            </div>
                            <div class="card-body ">
                                @if (session('status'))
                                    <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-actions text-right">
                                                    <a class="editCity" rel="tooltip" class="btn btn-success btn-link"
                                                        href="{{ route('projects.edit', $category->id) }}"
                                                        data-original-title="" title="" data-toggle="modal"
                                                        data-id="{{ $category->id }}" data-target="#categoryModal">
    ...
    <div class="modal fade" id="categoryModal" tabindex="-1" role="">
